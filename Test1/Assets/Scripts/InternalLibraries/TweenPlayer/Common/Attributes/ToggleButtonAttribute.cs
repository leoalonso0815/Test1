...
namespace UnityExtensions
{
    ...
    {
        public ToggleButtonAttribute(string trueText, string falseText)
        {
#if UNITY_EDITOR
            _trueText = trueText;
        ...
        public ToggleButtonAttribute(string label, string trueText, string falseText, int width)
        {
#if UNITY_EDITOR
        ...
        class ToggleButtonDrawer : BasePropertyDrawer<ToggleButtonAttribute>
        {
            public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
            {
                ...
                if (attribute._width > 0)
                {
                    position.width = attribute._width;
                }
